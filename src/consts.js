...
module.exports = {
    ...
    eventNames: {
        ...
        windowCmdCreateBrowserView: "window.cmd.createbrowserview",
        ...
        windowCmdIsMaximized: "window.cmd.ismaximized",
        windowCmdSetFullscreen: "window.cmd.setfullscreen",
        ...
        windowEventIsMaximized: "window.event.ismaximized",
        windowEventFullscreen: "window.event.fullscreen",
        ...
        windowEventSetAutoResize: "window.event.setautoresize",
